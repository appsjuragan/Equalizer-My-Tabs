...
export class DynamicsProcessor {
    ...
    set_limiter_params(threshold: number, knee: number, detector_mode: DetectorMode, lookahead_ms: number, rms_time_ms: number): void;
}
...
export interface InitOutput {
    ...
    readonly dynamicsprocessor_set_limiter_params: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
    ...
    readonly juraganaudiodsp_set_limiter_params: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
